...
export default function SplashCursor({
    ...
    useEffect(() => {
        ...
        const canvasContext = getWebGLContext(canvas);
        if (!canvasContext) return;
        const { gl, ext } = canvasContext;
        ...
        function getWebGLContext(canvas: HTMLCanvasElement) {
            ...
            if (isWebGL2) {
                formatRGBA = getSupportedFormat(gl, (gl as WebGL2RenderingContext).RGBA16F, gl.RGBA, halfFloatTexType, supportLinearFiltering);
            ...
            if (!supportRenderTextureFormat(gl, internalFormat, format, type)) {
                if ('drawBuffers' in gl) {
                    ...
                    switch (internalFormat) {
                        case gl2.R16F:
                            return getSupportedFormat(gl2, gl2.RG16F, gl2.RG, type, supportLinearFiltering);
                        case gl2.RG16F:
                            return getSupportedFormat(gl2, gl2.RGBA16F, gl2.RGBA, type, supportLinearFiltering);
                        default:
                            return null;
                    }
                }
